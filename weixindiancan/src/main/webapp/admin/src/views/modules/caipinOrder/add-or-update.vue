    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="配送员" prop="caipinOrderCourierName">
                       <el-input v-model="ruleForm.caipinOrderCourierName"
                                 placeholder="配送员" clearable  :readonly="ro.caipinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="配送员" prop="caipinOrderCourierName">
                           <el-input v-model="ruleForm.caipinOrderCourierName"
                                     placeholder="配送员" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
